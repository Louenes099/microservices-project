package com.albayrak.microservices.core.review.presentationlayer.controllers;
...
public class ReviewRESTController implements ReviewServiceAPI {
    ...
    public List<Review> getReviews(int productId) {
        ...
        listReviews.add(new Review(productId, 1, "Author 1", "Subject 1", "Content 1", serviceUtils.getServiceAddress()));
        listReviews.add(new Review(productId, 2, "Author 2", "Subject 2", "Content 2", serviceUtils.getServiceAddress()));
        listReviews.add(new Review(productId, 3, "Author 3", "Subject 3", "Content 3", serviceUtils.getServiceAddress()));
